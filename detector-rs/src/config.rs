...
pub struct Config {
    ...
    pub high_charge_threshold: i64,
    pub high_charge_min_members: usize,
    pub charge_one_score_penalty: f64,
    pub charge_prior_strength: f64,
...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            high_charge_threshold: 5,
            high_charge_min_members: 3,
            charge_one_score_penalty: 0.85,
            charge_prior_strength: 0.15,
